...
file ../../sql/ts_pdb.sql path=opt/ercole-agent/sql/ts_pdb.sql owner=root \
    group=bin mode=0644
depend type=require fmri=pkg:/runtime/perl-522@5.22.1.1-11.4.0.0.1.14.0
depend type=require fmri=pkg:/shell/ksh93@93.21.1.20120801-11.4.0.0.1.14.0
depend type=require fmri=pkg:/system/core-os@11.4-11.4.0.0.1.15.0
